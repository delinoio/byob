...
require (
	...
	github.com/delinoio/byob/lint/upstream v0.0.0-00010101000000-000000000000
...
require (
	...
	github.com/web-infra-dev/rslint/byobbridge v0.0.0 // indirect
...
replace github.com/delinoio/byob/lint/upstream => ./lint/upstream
